...
module.exports = "<iframe [style.height.px]=\"Height\" id=\"sc-widget\" src=\"https://w.soundcloud.com/player/?url=https://soundcloud.com/ketchuplube/sets/bimmers-weiners\" width=\"100%\"\n  height=\"465\" scrolling=\"no\" frameborder=\"no\"></iframe>\n<script src=\"https://w.soundcloud.com/player/api.js\" type=\"text/javascript\"></script>\n\n"
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        for (eventKey in SC.Widget.Events) {
            if (eventKey === 'READY') {
                this.Widget.bind(SC.Widget.Events[eventKey], function () {
                    _this.Widget.play();
                });
            }
            if (eventKey === 'PLAY_PROGRESS') {
                this.Widget.bind(SC.Widget.Events[eventKey], function (data) {
                    //console.log(data);
                    _this.Widget.getCurrentSound(function (songData) {
